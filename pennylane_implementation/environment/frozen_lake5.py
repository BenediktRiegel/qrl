...
class FrozenLake5(Environment):
    ...
    def move_in_direction(
        ...
        for edge_case in self.possible_edge_cases:
            ...
            self.check_edge_case(edge_case, x_qubits, y_qubits, e_qubit, [end_state_qubit] + ancilla_qubits, action_qubits + next_x_qubits + next_y_qubits + unclean_qubits)
            ...
            qml.adjoint(self.check_edge_case)(edge_case, x_qubits, y_qubits, e_qubit, [end_state_qubit] + ancilla_qubits, action_qubits + next_x_qubits + next_y_qubits + unclean_qubits)
