...
from .tree_loader import BinaryTreeNode
...
class LittleTreeLoader:
    ...
    def load_tree(self, tree_idx: int, control_qubits: List[int] = None, ancilla_qubits: List[int] = None, unclean_qubits: List[int] = None):
        ...
        self.qubit_rotations(0, self.binary_trees[tree_idx], control_qubits, ancilla_qubits, unclean_qubits, tree_idx=tree_idx)

    def circuit(self, control_qubits: List[int] = None, ancilla_qubits: List[int] = None, unclean_qubits: List[int] = None):
        self.load_tree(0, control_qubits, ancilla_qubits, unclean_qubits)
