...
class Logger:
    ...
    def log(self, iterations: int, type_itr: int, sub_iteration: int, sub_it_time: float, total_time: float, value_loss: float, action_loss: float, action_probs: Iterable[Iterable[float]], state_values: Iterable[float], value_grad: Iterable[float], action_grad: Iterable[Iterable[float]], action_params_change, value_params_change):
